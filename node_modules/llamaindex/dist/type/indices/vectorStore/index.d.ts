...
import type { MetadataFilters, VectorStore, VectorStoreQuery, VectorStoreQueryResult } from "../../storage/index.js";
...
export declare class VectorIndexRetriever implements BaseRetriever {
    ...
    protected sendEvent(query: string, nodesWithScores: NodeWithScore<Metadata>[]): void;
