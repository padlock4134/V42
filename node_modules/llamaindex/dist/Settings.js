 ...
 */ class GlobalSettings {
    ...
    #embedModelAsyncLocalStorage = new AsyncLocalStorage();
    #nodeParserAsyncLocalStorage = new AsyncLocalStorage();
    #chunkSizeAsyncLocalStorage = new AsyncLocalStorage();
    #chunkOverlapAsyncLocalStorage = new AsyncLocalStorage();
    #promptAsyncLocalStorage = new AsyncLocalStorage();
    get debug() {
        const debug = getEnv("DEBUG");
        return getEnv("NODE_ENV") === "development" && Boolean(debug) && debug?.includes("llamaindex");
    }
    get llm() {
        if (this.#llm === null) {
            this.#llm = new OpenAI();
